				...
				<div class="max-w-5xl m-auto text-white flex flex-wrap justify-center">
					<div class="p-5 w-48 ">
						...
						<a class="my-3 block" href="/#">
							AR Models<span class="text-teal-600 text-xs p-1"></span>
						</a>
					</div>
					...
					<div class="md:flex-auto md:flex-row-reverse mt-2 gap-4 flex-row flex p-5 w-48 ">
						<a href="/#" class="w-6 mx-1">
							<img src="https://img.icons8.com/ios-filled/50/ffffff/facebook--v1.png" alt="" />
						</a>
						<a href="/#" class="w-6 mx-1">
							<img src="https://img.icons8.com/material-outlined/50/ffffff/instagram-new.png" alt="" />
						</a>
						<a href="/#" class="w-6 mx-1">
							<img src="https://img.icons8.com/ios-glyphs/50/ffffff/linkedin.png" alt="" />
						</a>
					</div>
				</div>
			</div>
