...
export default function Services() {
	return (
		<div className="font-popins pt-10" style={{ backgroundColor: '#1F1627' }} id="services">
					...
					<div className="relative w-72 p-6 my-4 bg-white shadow-xl rounded-3xl">
						...
						<div className="mt-8">
							...
							<div className="flex space-x-2 font-medium text-gray-800 text-basic">
								<p>
									Digital 3D models allow students to visualize and interrogate various topics; they reinforce spatial skills, facilitate student
									recognition of pre-learned various principles in the field, and encourage students to think about their processes and properties.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="relative w-72 p-6 my-4 bg-white shadow-xl rounded-3xl">
						...
						<div className="mt-8">
							...
							<div className="flex space-x-2 text-gray-800 text-basic">
								<p>
									Augmented Reality's relative seamlessness of digital objects within the real world encourages interactivity and engagement. It
									maximizes students' ability to spend their time learning curricular subjects while minimizing the time spent learning how to use the
									new tech.
								</p>
							</div>
						</div>
